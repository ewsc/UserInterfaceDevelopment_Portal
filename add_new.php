<?php
    ...
    $sql = "INSERT INTO main (name, added_by, desc_short, desc_full, image, link, date_arr, action_arr) VALUES ('$name', '$added_by', '$desc_short', '$desc_full', '$newName', '$link', '$time_arr', '$action_arr')";
